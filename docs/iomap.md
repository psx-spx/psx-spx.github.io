#   I/O Map
All unofficial (i.e. not derived from Sony's own documentation) register names
are suffixed with a question mark.
...
```
  ...
  1F801008h          4   DEV0_CTRL?  DEV0 (PIO)      Delay/Size   (usually 0013243Fh; 512Kbytes 8bit-bus)
  1F80100Ch          4   DEV1_CTRL?  DEV1 (debug)    Delay/Size   (usually 00003022h; 1 byte)
  1F801010h          4   DEV2_CTRL?  DEV2 (BIOS ROM) Delay/Size   (usually 0013243Fh; 512Kbytes 8bit-bus)
  1F801014h          4   DEV4_CTRL?  DEV4 (SPU)      Delay/Size   (usually 200931E1h)
  1F801018h          4   DEV5_CTRL?  DEV5 (CD-ROM)   Delay/Size   (usually 00020843h or 00020943h)
  1F80101Ch          4   DEV8_CTRL?  DEV8 (debug)    Delay/Size   (usually 00070777h; 128-bytes 8bit-bus)
...
```
  ...
  1F801810h.Read     4   GP0?        Read responses to GP0(C0h) and GP1(10h) commands
  1F801814h.Write    4   GP1?        Send GP1 Commands (Display Control)
  1F801814h.Read     4   GPU_STAT    Read GPU Status Register
```
#### MDEC Registers
```
  1F801820h.Write    4   MDEC_?      MDEC Command/Parameter Register (W)
  1F801820h.Read     4   MDEC_?      MDEC Data/Response Register (R)
  1F801824h.Write    4   MDEC_?      MDEC Control/Reset Register (W)
  1F801824h.Read     4   MDEC_?      MDEC Status Register (R)
```
...
```
  ...
  1F802021h/Read     1               DUART Status Register A (R)
  1F802021h/Write    1               DUART Clock Select Register A (W)
  1F802022h/Read     1               DUART Toggle Baud Rate Generator Test Mode (Read=Strobe)
  1F802022h/Write    1               DUART Command Register A (W)
  1F802023h/Read     1               DUART Rx Holding Register A (FIFO) (R)
  1F802023h/Write    1               DUART Tx Holding Register A (W)
  1F802024h/Read     1               DUART Input Port Change Register (R)
  1F802024h/Write    1               DUART Aux. Control Register (W)
  1F802025h/Read     1               DUART Interrupt Status Register (R)
  1F802025h/Write    1               DUART Interrupt Mask Register (W)
  1F802026h/Read     1               DUART Counter/Timer Current Value, Upper/Bit15-8 (R)
  1F802026h/Write    1               DUART Counter/Timer Reload Value,  Upper/Bit15-8 (W)
  1F802027h/Read     1               DUART Counter/Timer Current Value, Lower/Bit7-0 (R)
  1F802027h/Write    1               DUART Counter/Timer Reload Value,  Lower/Bit7-0 (W)
  1F802028h/1st      1               DUART Mode Register 1.B (R/W)
  1F802028h/2nd      1               DUART Mode Register 2.B (R/W)
  1F802029h/Read     1               DUART Status Register B (R)
  1F802029h/Write    1               DUART Clock Select Register B (W)
  1F80202Ah/Read     1               DUART Toggle 1X/16X Test Mode (Read=Strobe)
  1F80202Ah/Write    1               DUART Command Register B (W)
  1F80202Bh/Read     1               DUART Rx Holding Register B (FIFO) (R)
  1F80202Bh/Write    1               DUART Tx Holding Register B (W)
  1F80202Ch/None     1               DUART Reserved Register (neither R nor W)
  1F80202Dh/Read     1               DUART Input Port (R)
  1F80202Dh/Write    1               DUART Output Port Configuration Register (W)
  1F80202Eh/Read     1               DUART Start Counter Command (Read=Strobe)
  1F80202Eh/Write    1               DUART Set Output Port Bits Command (Set means Out=LOW)
  1F80202Fh/Read     1               DUART Stop Counter Command (Read=Strobe)
  1F80202Fh/Write    1               DUART Reset Output Port Bits Command (Reset means Out=HIGH)
```
#### DEV8 - Int/Dip/Post
```
